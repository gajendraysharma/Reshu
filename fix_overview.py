...
overview_block = r'\{\/\* PAGE 1: OVERVIEW \*\/\}.*?\{\/\* PAGE 2: BUSINESS HEALTH DASHBOARD \*\/\}'

new_overview = r'''{/* PAGE 1: OVERVIEW */}
          {activeTab === 'OVERVIEW' && (
