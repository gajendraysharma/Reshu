...
(async () => {
  ...
  const html = await page.evaluate(() => {
     const hasPrintDossier = !!document.querySelector('.print-dossier-root');
     const printPages = document.querySelectorAll('.print-page').length;
     return { hasPrintDossier, printPages };
  });
