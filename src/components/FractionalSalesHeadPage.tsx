        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 space-y-12">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4 sm:gap-6">
            <div className="bg-slate-50 border border-slate-200 rounded-2xl p-6 text-center flex flex-col items-center gap-4 shadow-sm hover:border-blue-300 hover:shadow-md transition-all duration-300">
              ...
              <span className="text-[15px] font-bold text-slate-800 leading-snug">Sales Strategy & Planning</span>
            </div>
            ...
            <div className="bg-slate-50 border border-slate-200 rounded-2xl p-6 text-center flex flex-col items-center gap-4 shadow-sm hover:border-blue-300 hover:shadow-md transition-all duration-300">
              ...
              <span className="text-[15px] font-bold text-slate-800 leading-snug">Revenue Growth Reviews</span>
            </div>
            ...
            <div className="bg-slate-50 border border-slate-200 rounded-2xl p-6 text-center flex flex-col items-center gap-4 shadow-sm hover:border-blue-300 hover:shadow-md transition-all duration-300">
              ...
              <span className="text-[15px] font-bold text-slate-800 leading-snug">Sales Pipeline Management</span>
            </div>
            ...
            <div className="bg-slate-50 border border-slate-200 rounded-2xl p-6 text-center flex flex-col items-center gap-4 shadow-sm hover:border-blue-300 hover:shadow-md transition-all duration-300">
              ...
              <span className="text-[15px] font-bold text-slate-800 leading-snug">Team Coaching & Performance</span>
            </div>
            ...
            <div className="bg-slate-50 border border-slate-200 rounded-2xl p-6 text-center flex flex-col items-center gap-4 shadow-sm hover:border-blue-300 hover:shadow-md transition-all duration-300 lg:col-start-2">
              ...
              <span className="text-[15px] font-bold text-slate-800 leading-snug">Go-To-Market Support</span>
            </div>
            ...
            <div className="bg-slate-50 border border-slate-200 rounded-2xl p-6 text-center flex flex-col items-center gap-4 shadow-sm hover:border-blue-300 hover:shadow-md transition-all duration-300">
              ...
              <span className="text-[15px] font-bold text-slate-800 leading-snug">KPI Monitoring & Business Reviews</span>
            </div>
            ...
            <div className="bg-slate-50 border border-slate-200 rounded-2xl p-6 text-center flex flex-col items-center gap-4 shadow-sm hover:border-blue-300 hover:shadow-md transition-all duration-300 lg:col-start-3 lg:-mt-0 md:col-span-2 lg:col-span-1">
              ...
              <span className="text-[15px] font-bold text-slate-800 leading-snug">Leadership Guidance</span>
            </div>
          </div>
            ...
            <div className="space-y-12">
              ...
              <div className="space-y-6">
                ...
                <div className="grid gap-3">
                  <div className="border border-slate-200 rounded-xl p-4 flex items-start gap-3 bg-white shadow-sm">
              ...
              <div className="space-y-6">
                ...
                <div className="grid gap-3">
                  <div className="bg-emerald-50/50 border border-emerald-100 rounded-xl p-4 flex items-center gap-4 shadow-sm">
            ...
            <div className="lg:pt-16">
              <div className="bg-white rounded-3xl border-2 border-slate-200 shadow-xl p-8 sm:p-12 text-center space-y-8 sticky top-32">
                ...
                <div className="space-y-6">
                  ...
                  <div className="inline-flex items-center gap-2 bg-blue-50 text-blue-700 text-sm font-bold tracking-wide px-5 py-2.5 rounded-full border border-blue-200">
      ...
      <section className="py-16 lg:py-24 bg-gradient-to-br from-[#0f2142] via-slate-900 to-blue-950 text-center relative overflow-hidden">
        ...
        <div className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10 space-y-10">
          ...
          <div className="bg-white/10 backdrop-blur-md border border-white/20 rounded-2xl p-8 max-w-xl mx-auto shadow-2xl space-y-8">
            ...
            <button
              onClick={onContactUs}
              className="w-full bg-blue-600 hover:bg-blue-500 text-white font-bold text-sm lg:text-base uppercase px-8 py-5 rounded-xl shadow-lg transition-all active:scale-95 cursor-pointer flex items-center justify-center gap-2"
            >
