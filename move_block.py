...
block_to_move = '''              <div className="bg-gradient-to-br from-[#152238] to-[#0a1128] rounded-2xl shadow-lg border border-slate-800 p-8 md:p-10 relative overflow-hidden">
...
target_position_str = '''            <div className="lg:col-span-4 flex flex-col gap-8">
...
replacement = '''            <div className="lg:col-span-4 flex flex-col gap-8">
''' + block_to_move + '''              <div className="bg-[#152238] rounded-2xl shadow-lg border border-slate-800 p-8 md:p-10">
                <h3 className="text-[#e5c158] text-lg font-bold border-b border-slate-700 pb-2 mb-6">What You'll Receive</h3>'''

content = content.replace(target_position_str, replacement)
